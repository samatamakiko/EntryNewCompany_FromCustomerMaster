            ...
            foreach (Company c in CompanyList)
            {
                ...
                using (var connection = new SqlConnection(connectionString))
                {
                    ...
                    Console.WriteLine($"{output}");
                        ...
                        /*if (output == 1)
                        {
                            CompanyCheck = CompanyCheck +"\r"+ $"{c.CompanyName}Å@ìoò^çœ";
                        }
                        else if (output == 0)
                        {
                            CompanyCheck =Å@CompanyCheck +"\r"+ $"ÅöÅöÅöÅöÅö{c.CompanyName}Ç™BAWÇ÷ìoò^Ç≥ÇÍÇ‹ÇµÇΩÅöÅöÅöÅöÅö";
                        }*/
                        if (output == 0)
                        {
                            CompanyCheck = CompanyCheck + "\r" + $"ÅöÅöÅöÅöÅö{c.CompanyName}Ç™BAWÇ÷ìoò^Ç≥ÇÍÇ‹ÇµÇΩÅöÅöÅöÅöÅö";
